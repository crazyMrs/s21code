...
START_TEST(s21_sub_54) {
  ...
  // src1 = -1337;
  // src2 = -22.8;
  src1.bits[0] = 0b00000000000000000000010100111001;
  src1.bits[1] = 0b00000000000000000000000000000000;
  src1.bits[2] = 0b00000000000000000000000000000000;
  src1.bits[3] = 0b10000000000000000000000000000000;
  src2.bits[0] = 0b00000000000000000000000011100100;
  src2.bits[1] = 0b00000000000000000000000000000000;
  src2.bits[2] = 0b00000000000000000000000000000000;
  ...
  value_type_origin = 0;
  // -1314.2
  origin.bits[0] = 0b00000000000000000011001101010110;
  origin.bits[1] = 0b00000000000000000000000000000000;
  origin.bits[2] = 0b00000000000000000000000000000000;
...
START_TEST(s21_sub_55) {
  ...
  // src1 = -22.8;
  // src2 = -1337;
  src1.bits[0] = 0b00000000000000000000000011100100;
  src1.bits[1] = 0b00000000000000000000000000000000;
  src1.bits[2] = 0b00000000000000000000000000000000;
  src1.bits[3] = 0b10000000000000010000000000000000;
  src2.bits[0] = 0b00000000000000000000010100111001;
  src2.bits[1] = 0b00000000000000000000000000000000;
  src2.bits[2] = 0b00000000000000000000000000000000;
  src2.bits[3] = 0b10000000000000000000000000000000;
  value_type_result = s21_sub(src1, src2, &result);
...
START_TEST(test_from_decimal_to_int_1) {
  ...
  int error = s21_from_decimal_to_int(value, &s21_result);

  ck_assert_int_eq(error, 0);
  ck_assert_int_eq(s21_result, system_result);
}
END_TEST

START_TEST(test_from_decimal_to_int_2) {
  s21_decimal value = {{0x00000001, 0, 0, 0}};  // 1
  int system_result = 1;
  int s21_result;
...
START_TEST(test_from_decimal_to_int_3) {
  s21_decimal value = {{0x00000001, 0, 0, 0x80000000}};  // -1
  int system_result = -1;
  int s21_result;
...
START_TEST(test_from_decimal_to_int_4) {
  s21_decimal value = {{0x0000000F, 0, 0, 0x80010000}};  // -1.5
  int system_result = -1;
  int s21_result;
...
START_TEST(test_from_decimal_to_int_5) {
  s21_decimal value = {{7, 0, 0, 0x00010000}};  // 0.7
  int system_result = 0;
  int s21_result;
...
START_TEST(test_from_decimal_to_int_6) {
  s21_decimal value = {{0x075BCD15, 0, 0, 0x80090000}};  // 0.123456789
  int system_result = 0;
  int s21_result;
...
START_TEST(test_from_decimal_to_int_7) {
  s21_decimal value = {{0xFFFFFFFF, 0, 0, 0x00060000}};  // 4294.967295
...
START_TEST(test_from_decimal_to_int_8) {
  s21_decimal value = {{999999, 0, 0, 0x00050000}};  // 9.99999
  int system_result = 9;
  int s21_result;
...
START_TEST(test_from_decimal_to_int_11) {
  s21_decimal value = {{2, 0, 0, 0x00140000}};  // 0.00000000000000000002
  int system_result = 0;
  int s21_result;
...
START_TEST(test_from_decimal_to_int_12) {
  s21_decimal value = {{0x00000000, 0x00000001, 0x00000000, 0x00000000}};
  int system_result = 0;
  int s21_result;
...
START_TEST(test_from_decimal_to_int_13) {  // 4294967295.999
  s21_decimal value = {{0xFFFFFFFF, 0x000003E7, 0x00000000, 0x00030000}};
...
START_TEST(test_from_decimal_to_int_14) {  // -4294967295.999
  s21_decimal value = {{0xFFFFFFFF, 0x000003E7, 0x00000000, 0x80030000}};
  int system_result = -2147483647;
  int s21_result;
...
START_TEST(test_add_1) {
  ...
  s21_decimal system_result = {{0, 0, 0, 0}};  // 0

  int s21_error_code = s21_add(value_1, value_2, &s21_result);
  int system_error_code = 0;

  ck_assert_int_eq(s21_error_code, system_error_code);
  ck_assert_int_eq(s21_result.bits[0], system_result.bits[0]);
  ck_assert_int_eq(s21_result.bits[1], system_result.bits[1]);
  ck_assert_int_eq(s21_result.bits[2], system_result.bits[2]);
  ck_assert_int_eq(s21_result.bits[3], system_result.bits[3]);
}
END_TEST

START_TEST(test_add_2) {
  s21_decimal value_1 = {{0, 0, 0, 0}};           // 0
  s21_decimal value_2 = {{0, 0, 0, 0x80010000}};  // 0.0
  s21_decimal s21_result;
  s21_decimal system_result = {{0, 0, 0, 0x00010000}};  // 0.0
...
START_TEST(test_add_3) {
  s21_decimal value_1 = {{8, 0, 0, 0x800E0000}};  // -0.00000000000008
  s21_decimal value_2 = {{6, 0, 0, 0x000F0000}};  // 0.000000000000006
  s21_decimal s21_result;
  s21_decimal system_result = {{74, 0, 0, 0x800F0000}};  //-0.000000000000002
...
START_TEST(test_add_4) {
  s21_decimal value_1 = {{99, 0, 0, 0x00010000}};  // 9.9
  s21_decimal value_2 = {{1000, 0, 0, 0}};         // 1000
  s21_decimal s21_result;
  s21_decimal system_result = {{10099, 0, 0, 0x00010000}};  // 1009.9
...
START_TEST(test_add_5) {
  s21_decimal value_1 = {{12345, 0, 0, 0x00020000}};  // 123.45
  s21_decimal value_2 = {{6789, 0, 0, 0x00020000}};   // 67.89
  s21_decimal s21_result;
  s21_decimal system_result = {{19134, 0, 0, 0x00020000}};  // 191.34
...
START_TEST(test_add_7) {
  s21_decimal value_1 = {{45, 0, 0, 0x00010000}};  // 4.5
  s21_decimal value_2 = {{1, 0, 0, 0}};            // 1
  s21_decimal s21_result;
  s21_decimal system_result = {{55, 0, 0, 0x00010000}};  // 5.5
...
START_TEST(test_add_8) {
  s21_decimal value_1 = {{0xFFFFFFFD, 0xFFFFFFFF, 0xFFFFFFFF,
                          0}};  // 79228162514264337593543950333
  s21_decimal value_2 = {{0x00000031, 0, 0, 0x00020000}};  // 0.49
  s21_decimal s21_result;
  s21_decimal system_result = {{0xFFFFFFFD, 0xFFFFFFFF, 0xFFFFFFFF,
                                0}};  // 79228162514264337593543950333
  ...
  ck_assert_int_eq(s21_error_code, system_error_code);
  for (int i = 0; i < 4; i++) {
    ck_assert_int_eq(s21_result.bits[i], system_result.bits[i]);
  }
}
END_TEST
...
START_TEST(test_add_10) {
  ...
  s21_decimal s21_result;
  s21_decimal system_result = {{0x4E81E240, 0x00000918, 0,
...
START_TEST(test_add_11) {
  s21_decimal value_1 = {{0x80000000, 0x80000000, 0x80000000, 0}};
  s21_decimal value_2 = {{0, 0, 0, 0x001C0000}};
  s21_decimal s21_result;
  s21_decimal system_result = {{0x80000000, 0x80000000, 0x80000000, 0}};
...
START_TEST(test_add_13) {
  s21_decimal value_1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
                          0}};  // 79228162514264337593543950335
  s21_decimal value_2 = {{0, 0, 0, 0x000A0000}};  // 0.0000000000
  s21_decimal s21_result;
  s21_decimal system_result = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
                                0}};  // 79228162514264337593543950335
...
START_TEST(test_add_14) {
  s21_decimal value_1 = {{0xFFFFFFFE, 0xFFFFFFFF, 0xFFFFFFFF,
                          0}};  // 79228162514264337593543950334
  s21_decimal value_2 = {{0x00000033, 0, 0, 0x00020000}};  // 0.51
  s21_decimal s21_result;
  s21_decimal system_result = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
                                0}};  // 79228162514264337593543950335
...
START_TEST(test_add_15) {
  ...
  s21_decimal value_2 = {{0x00000031, 0, 0, 0x00020000}};  // 0.49
  s21_decimal s21_result;
  s21_decimal system_result = {{0xFFFFFFFE, 0xFFFFFFFF, 0xFFFFFFFF,
                                0}};  // 79228162514264337593543950334
...
START_TEST(test_add_16) {
  s21_decimal value_1 = {{9999, 0, 0, 0x00040000}};  // 0.9999
  s21_decimal value_2 = {{1, 0, 0, 0x00040000}};     // 0.0001
  s21_decimal s21_result;
  s21_decimal system_result = {{10000, 0, 0, 0x00040000}};  // 1.0000
...
START_TEST(test_add_17) {
  s21_decimal value_1 = {{0xFFFFFFFD, 0xFFFFFFFF, 0xFFFFFFFF,
                          0}};  // 79228162514264337593543950333
  s21_decimal value_2 = {{0x00000005, 0, 0, 0x00010000}};  // 0.5
  s21_decimal s21_result;
  s21_decimal system_result = {{0xFFFFFFFE, 0xFFFFFFFF, 0xFFFFFFFF,
                                0}};  // 79228162514264337593543950334
...
START_TEST(test_add_error_1) {
  s21_decimal value_1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
                          0}};  // 79228162514264337593543950335
  s21_decimal value_2 = {{9, 0, 0, 0x00010000}};  // 0.9
  s21_decimal s21_result;
...
START_TEST(test_add_error_2) {
  s21_decimal value_1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
                          0x80000000}};  // -79228162514264337593543950335
  s21_decimal value_2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
                          0x80000000}};  // -79228162514264337593543950335
  s21_decimal s21_result;
...
void srunner_add_comparsion_tests(SRunner *sr) {
  ...
  tcase_add_test(tc1_1, s21_is_equalal_16);
...
void srunner_add_cast_tests(SRunner *sr) {
  ...
  tcase_add_test(tc1_1, test_from_decimal_to_int_1);
  tcase_add_test(tc1_1, test_from_decimal_to_int_2);
  tcase_add_test(tc1_1, test_from_decimal_to_int_3);
  tcase_add_test(tc1_1, test_from_decimal_to_int_4);
  tcase_add_test(tc1_1, test_from_decimal_to_int_5);
  tcase_add_test(tc1_1, test_from_decimal_to_int_6);
  tcase_add_test(tc1_1, test_from_decimal_to_int_7);
  tcase_add_test(tc1_1, test_from_decimal_to_int_8);
  tcase_add_test(tc1_1, test_from_decimal_to_int_9);
  tcase_add_test(tc1_1, test_from_decimal_to_int_10);
  tcase_add_test(tc1_1, test_from_decimal_to_int_11);
  tcase_add_test(tc1_1, test_from_decimal_to_int_12);
  tcase_add_test(tc1_1, test_from_decimal_to_int_13);
  tcase_add_test(tc1_1, test_from_decimal_to_int_14);
